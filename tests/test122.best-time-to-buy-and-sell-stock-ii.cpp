...
#include <vector>
#include <solutions/122.best-time-to-buy-and-sell-stock-ii.hpp>

TEST_CASE("test 122.best-time-to-buy-and-sell-stock-ii", "[122.best-time-to-buy-and-sell-stock-ii]") {
  Solution s;
